...
GitHub Repository for [https://github.com/sad8182/edgetunnel](https://github.com/sad8182/edgetunnel)
...
1. Copy `_worker.js` code from [here](https://github.com/sad8182/EDtunnel/blob/main/_worker.js).
